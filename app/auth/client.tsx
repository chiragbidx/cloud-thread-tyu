  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        ...
        description: "Start streamlining your payments in less than a minute.",
      };
    }
    return {
      id: "signin",
      title: "Sign in to PayFlow",
      description: "Enter your work email and password to access your team dashboard.",
    };
  }, [mode]);
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Fast, secure onboarding for every team.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Authenticate, invite your team, and manage payments—all in PayFlow’s polished, secure workspace.
              </p>
            </div>
